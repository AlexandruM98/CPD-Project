...
public class Controller {
    ...
    private SocketChannel createReceiverSocket() throws IOException {
        ...
        serverSocket.socket().bind(new InetSocketAddress("localhost", 1000));
        System.out.println("Waiting for user 3 to connect");
        client = serverSocket.accept();

        System.out.println("User 3 connected");
    ...
    private SocketChannel createSenderSocket() throws IOException {
        ...
        SocketAddress socketAddr = new InetSocketAddress("localhost", 1001);
        socketChannel.connect(socketAddr);
        ByteBuffer tokenBuffer = ByteBuffer.wrap("Alex".getBytes());
        System.out.println("User 1 sending token to user 2");
