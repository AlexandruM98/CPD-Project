...
public class Controller {
    ...
    private void createInputDialog() {
        SwingUtilities.invokeLater(() -> {
            ...
            Timer timer = new Timer(8000, e -> {
                ...
                this.inputText = textPane.getText();
            });
    ...
    private SocketChannel createReceiverSocket() throws IOException {
        ...
        serverSocket.socket().bind(new InetSocketAddress("localhost", 1001));
        System.out.println("Waiting for user 1 to connect");
    ...
    private SocketChannel createSenderSocket() throws IOException {
        ...
        SocketAddress socketAddr = new InetSocketAddress("localhost", 1002);
